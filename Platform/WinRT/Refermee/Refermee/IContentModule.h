...
public:
	...
	property CFI^ CFI
	{
		Refermee::CFI^ get()
		{
			return ref new Refermee::CFI(_native.CFI());
		}
	}
	...
	{
		Refermee::ManifestItem^ get()
		{
			return Refermee::ManifestItem::Wrapper(std::const_pointer_cast<::ePub3::ManifestItem>(_native.ManifestItem()));
		}
	}
