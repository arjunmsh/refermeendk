...
#ifndef __Refermee_Buffer_Bridge_h__
#define __Refermee_Buffer_Bridge_h__
...
{
	InspectableClass(TEXT("RuntimeClass_Refermee_BridgedBuffer"), BaseTrust);
...
#endif	/* __Refermee_Buffer_Bridge_h__ */
