 ...
 */
JNIEXPORT void JNICALL Java_org_refermee_sdk_android_EPub3_setCachePath(JNIEnv* env, jobject thiz, jstring cachePath);
 ...
 */
JNIEXPORT void JNICALL Java_org_refermee_sdk_android_EPub3_setContentFiltersRegistrationHandler(JNIEnv* env, jobject thiz, jobject handler);
 ...
 */
JNIEXPORT jobject JNICALL Java_org_refermee_sdk_android_EPub3_openBook(JNIEnv* env, jobject thiz, jstring path);
