...
static const char *javaJavaObjectsFactoryClassName = "org/refermee/sdk/android/JavaObjectsFactory";

static const char *javaEPub3ClassName = "org/refermee/sdk/android/EPub3";
...
static bool LauncherErrorHandler(const ePub3::error_details& err)
{
    ...
    LOGD("REFERMEE SDK ERROR HANDLER (%s): %s\n", isSevereEpubError ? "warning" : "info", msg);
...
/**
 * Initializes the Refermee SDK.
 */
static void initializeRefermeeSDK(JNIEnv* env)
{
    m_env = env;

	LOGD("initializeRefermeeSDK(): initializing Refermee SDK...");
    ...
    if (contentFiltersRegistrationHandler != NULL) {
        LOGD("initializeRefermeeSDK(): calling content filters registration handler %p", contentFiltersRegistrationHandler);
        env->CallVoidMethod(contentFiltersRegistrationHandler, contentFiltersRegistrationHandler_Run_ID);
    }

	LOGD("initializeRefermeeSDK(): initialization of Refermee SDK finished");
}
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
	...
	INIT_STATIC_METHOD_ID_RETVAL(createSpineItem_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"createSpineItem", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;)Lorg/refermee/sdk/android/SpineItem;", ONLOAD_ERROR);
	INIT_STATIC_METHOD_ID_RETVAL(addSpineItemToList_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"addSpineItemToList", "(Ljava/util/List;Lorg/refermee/sdk/android/SpineItem;)V", ONLOAD_ERROR);

	INIT_STATIC_METHOD_ID_RETVAL(createNavigationTable_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"createNavigationTable", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/refermee/sdk/android/components/navigation/NavigationTable;", ONLOAD_ERROR);
	INIT_STATIC_METHOD_ID_RETVAL(createNavigationPoint_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"createNavigationPoint", "(Ljava/lang/String;Ljava/lang/String;)Lorg/refermee/sdk/android/components/navigation/NavigationPoint;", ONLOAD_ERROR);
	INIT_STATIC_METHOD_ID_RETVAL(addElementToParent_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"addElementToParent", "(Lorg/refermee/sdk/android/components/navigation/NavigationElement;Lorg/refermee/sdk/android/components/navigation/NavigationElement;)V", ONLOAD_ERROR);
	...
	INIT_STATIC_METHOD_ID_RETVAL(createManifestItem_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"createManifestItem", "(Ljava/lang/String;Ljava/lang/String;)Lorg/refermee/sdk/android/ManifestItem;", ONLOAD_ERROR);
	INIT_STATIC_METHOD_ID_RETVAL(addManifestItemToList_ID, javaJavaObjectsFactoryClass, javaJavaObjectsFactoryClassName,
			"addManifestItemToList", "(Ljava/util/List;Lorg/refermee/sdk/android/ManifestItem;)V", ONLOAD_ERROR);
...
/*
 * Class:     org_refermee_sdk_android_EPub3
 * Method:    setCachePath
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL
Java_org_refermee_sdk_android_EPub3_setCachePath(JNIEnv* env, jobject thiz, jstring cachePath) {
	const char* str;
 ...
 */
JNIEXPORT void JNICALL
Java_org_refermee_sdk_android_EPub3_setContentFiltersRegistrationHandler(JNIEnv* env, jobject thiz, jobject handler) {
 ...
 */
JNIEXPORT jboolean JNICALL Java_org_refermee_sdk_android_EPub3_isEpub3Book(JNIEnv* env, jobject thiz, jstring path) {
	// Initialize core ePub3 SDK
	initializeRefermeeSDK(env);
 ...
 * Class:     org_refermee_sdk_android_EPub3
 * Method:    openBook
 * Signature: (Ljava/lang/String;)Lorg/refermee/sdk/android/Container
 */
JNIEXPORT jobject JNICALL
Java_org_refermee_sdk_android_EPub3_openBook(JNIEnv* env, jobject thiz, jstring path) {
	// Initialize core ePub3 SDK
	initializeRefermeeSDK(env);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_refermee_sdk_android_EPub3_initialize(JNIEnv* env, jobject thiz) {
	// Initialize core ePub3 SDK
	initializeRefermeeSDK(env);
}
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_refermee_sdk_android_EPub3_releaseNativePointer(JNIEnv* env, jobject thiz, jlong ptr) {
