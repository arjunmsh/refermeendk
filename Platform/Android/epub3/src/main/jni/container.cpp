...
static const char *javaContainerClassName = "org/refermee/sdk/android/Container";

static const char *javaContainer_createContainerMethodName = "createContainer";
static const char *javaContainer_createContainerSignature = "(JLjava/lang/String;)Lorg/refermee/sdk/android/Container;";

static const char *javaContainer_addPackageToContainerMethodName = "addPackageToContainer";
static const char *javaContainer_addPackageToContainerSignature = "(Lorg/refermee/sdk/android/Container;Lorg/refermee/sdk/android/Package;)V";
...
/*
 * Class:     org_refermee_sdk_android_Container
 * Method:    nativeLoadData
 * Signature: (I)Ljava/lang/String;
 */
JNIEXPORT void JNICALL
Java_org_refermee_sdk_android_Container_nativeLoadData(JNIEnv* env, jobject thiz, jlong pckgPtr) {
	//TODO: load the container data instead of passing the path only, as in the package
}

JNIEXPORT jobject JNICALL Java_org_refermee_sdk_android_Container_nativeGetInputStream
