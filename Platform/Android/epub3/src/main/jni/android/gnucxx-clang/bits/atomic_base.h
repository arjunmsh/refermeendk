...
#include <stdbool.h>
#include <stdint.h>
#include "atomic_lockfree_defines.h"
...
#define ATOMIC_FLAG_INIT { 0 }
    ...
    struct atomic_flag : public __atomic_flag_base
    {
        ...
        {
            return __c11_atomic_exchange (&_M_i, true, __m);
        }
        ...
        {
            __c11_atomic_store (&_M_i, false, __m);
        }
    ...
    private:
        ...
        mutable _Atomic(__int_type) 	_M_i;
    ...
    public:
        ...
        __int_type
        operator++() noexcept
        { return fetch_add(__int_type(1)) + __int_type(1); }
        ...
        __int_type
        operator--() noexcept
        { return fetch_sub(__int_type(1)) - __int_type(1); }
        ...
        { return __c11_atomic_is_lock_free (sizeof (_M_i)); }
        ...
        {
            __c11_atomic_store(&_M_i, __i, __m);
        }
        ...
        {
            return __c11_atomic_load_n(&_M_i, __m);
        }
        
        __int_type
        load(memory_order __m = memory_order_seq_cst) const volatile noexcept
        {
            return __c11_atomic_load(&_M_i, __m);
        }
        ...
        {
            return __c11_atomic_exchange(&_M_i, __i, __m);
        }
        ...
        {
            return __c11_atomic_compare_exchange_weak(&_M_i, &__i1, __i2, __m1, __m2);
        }
        ...
        compare_exchange_strong(__int_type& __i1, __int_type __i2,
                                memory_order __m1, memory_order __m2) noexcept
        {
            return __c11_atomic_compare_exchange_strong(&_M_i, &__i1, __i2, __m1, __m2);
        }
        ...
        fetch_add(__int_type __i,
                  memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_add(&_M_i, __i, __m); }
        ...
        fetch_sub(__int_type __i,
                  memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_sub(&_M_i, __i, __m); }
        ...
        fetch_and(__int_type __i,
                  memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_and(&_M_i, __i, __m); }
        ...
        fetch_or(__int_type __i,
                 memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_or(&_M_i, __i, __m); }
        ...
        fetch_xor(__int_type __i,
                  memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_xor(&_M_i, __i, __m); }
    ...
    private:
        ...
        mutable _Atomic(__pointer_type) 	_M_p;
    ...
    public:
        ...
        bool
        is_lock_free() const noexcept
        { return __c11_atomic_is_lock_free(_M_type_size(1)); }
        ...
        store(__pointer_type __p,
              memory_order __m = memory_order_seq_cst) noexcept
        {
            __c11_atomic_store(&_M_p, __p, __m);
        }
        ...
        load(memory_order __m = memory_order_seq_cst) const noexcept
        {
            return __c11_atomic_load(&_M_p, __m);
        }
        ...
        exchange(__pointer_type __p,
                 memory_order __m = memory_order_seq_cst) noexcept
        {
            return __c11_atomic_exchange(&_M_p, __p, __m);
        }
        ...
        {
            return __c11_atomic_compare_exchange_strong(&_M_p, &__p1, __p2, __m1, __m2);
        }
        ...
        fetch_add(ptrdiff_t __d,
                  memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_add(&_M_p, __d, __m); }
        ...
        fetch_sub(ptrdiff_t __d,
                  memory_order __m = memory_order_seq_cst) noexcept
        { return __c11_atomic_fetch_sub(&_M_p, __d, __m); }
