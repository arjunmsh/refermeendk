...
bool Package::Open(const string& path)
{
    ...
    if (status)
    {
        ...
        // See RefermeeJS package_document_parser.js updateMetadataWithIBookProperties()
        // https://github.com/refermee/refermee-js/blob/develop/epub-modules/epub/src/models/package_document_parser.js#L91
