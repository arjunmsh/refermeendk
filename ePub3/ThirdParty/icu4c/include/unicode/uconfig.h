...
// Refermee2: Some default settings
// Don't put 'using namespace icu' everywhere
#define U_USING_ICU_NAMESPACE 0
// Mark UnicodeString constructors as explicit
#define UNISTR_FROM_CHAR_EXPLICIT explicit
#define UNISTR_FROM_STRING_EXPLICIT explicit
// don't automatically include the individual utfX headers
