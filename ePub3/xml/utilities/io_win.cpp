...
{
	_store = ref new ::Refermee::XML::File(InputBuffer::read_cb, nullptr, InputBuffer::close_cb, (void*)this);
}
...
{
	_store = ref new ::Refermee::XML::File(nullptr, OutputBuffer::write_cb, OutputBuffer::close_cb, (void*)this);
}
